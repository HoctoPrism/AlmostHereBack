...
class DeleteSqlGtfsCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'gtfs:delete-sql';
     ...
     * @var string
     */
    protected $description = 'Delete one or multiple GTFS sql dumps';
    ...
    {
        $files = Storage::allFiles('gtfs/sql');
        ...
        if ($confirm && is_array($choices)) {
            ...
            foreach ($choices as $choice){
                ...
                $delete = Storage::delete('gtfs/sql/' . $arg);
